...
namespace Farm.Editor
{
    public class HuaTuoGenerator
    {
        ...
        private const string HotfixDllBuildName = "Farm.Hotfix.dll";
        private const string HotfixDllPath = "Assets/GameMain/Res/ResHotfix/Assembly";
        private const string HotfixDllName = "Farm.Hotfix.dll.bytes";
