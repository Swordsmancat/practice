...
public class BasicBehaviour : MonoBehaviour
{
	...
	public Transform CameraControl2;
	public Transform CameraControl_Lock;
	public Transform CameraControl_Aim;
	...
	private CharacterController rBody;                              // Reference to the player's rigidbody.
	...
	private LayerMask GetLayerMask =1<<6;
	...
	public CharacterController GetRigidBody { get { return rBody; } }
	...
	void Awake ()
	{
		...
		rBody = GetComponent<CharacterController>();
	...
	{
		return	Physics.CheckSphere(checkGround.position, groundDistance, GetLayerMask);
	}
}
