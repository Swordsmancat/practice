...
namespace Farm.Hotfix
{
    public class HPBarItem : MonoBehaviour
    {
        ...
        public bool Refresh()
        {
            ...
            {
                //获得坐标和旋转
                Vector3 worldPosition = m_Owner.CachedTransform.position + new Vector3(0f, m_Owner.CachedTransform.lossyScale.y * 2, 0f);
                ...
                //Log.Info(screenPosition);
                //Vector2 position;
                //if (RectTransformUtility.ScreenPointToLocalPointInRectangle((RectTransform)m_ParentCanvas.transform, worldPosition,
