...
namespace Farm.Hotfix
{
    public static class SoundExtension
    {
        ...
        public static int? PlayMoveSound(this SoundComponent soundComponent ,int soundId,float volume, Entity bindingEntity =null ,object userData = null)
        {
            IDataTable<DRSound> dtSound = GameEntry.DataTable.GetDataTable<DRSound>();
            DRSound drSound = dtSound.GetDataRow(soundId);
            if (drSound == null)
            ...
            playSoundParams.SpatialBlend = drSound.SpatialBlend;
            return soundComponent.PlaySound(AssetUtility.GetSoundAsset(drSound.AssetName), "MoveSound", Constant.AssetPriority.SoundAsset, playSoundParams, bindingEntity != null ? bindingEntity.Entity : null, userData);
        }
