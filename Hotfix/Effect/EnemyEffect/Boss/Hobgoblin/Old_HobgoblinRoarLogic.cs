...
{
    public class Old_HobgoblinRoarLogic : EnemySkillEffectLogic
    {
        private Old_HobgoblinLogic _owner;
        private readonly static string zhanhou = "zhanhou";
        protected override void OnShow(object userData)
        {
            base.OnShow(userData);
            _owner = Enemy.GetComponent<Old_HobgoblinLogic>();
            EffectStartPoint = GetEffectStartPoint(Enemy, zhanhou);
