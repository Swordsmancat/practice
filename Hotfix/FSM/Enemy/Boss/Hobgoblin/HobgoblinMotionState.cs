...
{
    public class HobgoblinMotionState : EnemyMotionState
    {
        ...
        public static new HobgoblinMotionState Create()
        {
            HobgoblinMotionState state = ReferencePool.Acquire<HobgoblinMotionState>();
            return state;
        }
