...
{
    public class HobgoblinWindState : EnemyBaseActionState
    {
        ...
        public static HobgoblinWindState Create()
        {
            HobgoblinWindState state = ReferencePool.Acquire<HobgoblinWindState>();
            return state;
        }
