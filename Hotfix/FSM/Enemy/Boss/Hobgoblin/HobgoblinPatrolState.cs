...
namespace Farm.Hotfix
{
    ...
    public class HobgoblinPatrolState : EnemyMotionState
    {
        ...
        public static new HobgoblinPatrolState Create()
        {
            HobgoblinPatrolState state = ReferencePool.Acquire<HobgoblinPatrolState>();
            return state;
        }
