...
namespace Farm.Hotfix
{
    public static class AssetUtility
    {
        ...
        public static string GetSkillSoundAsset(string assetName)
        {
            return Utility.Text.Format("Assets/GameMain/Skills/Sounds/{0}.wav", assetName);
        }

        public static string GetSkillDataAsset(string assetName)
        {
            return Utility.Text.Format("Assets/GameMain/Skills/{0}.asset", assetName);
        }

        public static string GetSkillEffectAsset(string assetName)
        {
            return Utility.Text.Format("Assets/GameMain/Skills/Effect/{0}.asset", assetName);
        }
