...
namespace Farm
{
    public static partial class Constant
    {
        public static class Setting
        {
            ...
            public const string PlayerLevel = "Setting.Level";
            public const string PlayerPhysical = "Setting.Physical";
            public const string PlayerPower = "Setting.Power";
            public const string PlayerAgility = "Setting.Agility";
            public const string PlayerDevout = "Setting.Devout";
